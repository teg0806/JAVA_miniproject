...
public class ClientMainMenu extends JPanel{
    ...
    private JPanel createCenterPanel(ClientMainFrame frame) {
        ...
        verticalButtonPanel.add(ButtonTamplate.createButton("로그인", e -> frame.changePanel(new ClientLoginMenu(frame, clientManager))));
        verticalButtonPanel.add(ButtonTamplate.createButton("회원가입", e -> frame.changePanel(new ClientJoinMenu(frame, clientManager))));
