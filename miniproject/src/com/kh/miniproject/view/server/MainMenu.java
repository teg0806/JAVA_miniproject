...
public class MainMenu extends JPanel{
    ...
    private JPanel createCenterPanel(MainFrame frame) {
        ...
        verticalButtonPanel.add(ButtonPanelTemplate.createButton("로그인", e -> frame.changePanel(new LoginMenu(frame))));
        verticalButtonPanel.add(ButtonPanelTemplate.createButton("회원가입", e -> frame.changePanel(new JoinMenu(frame))));
